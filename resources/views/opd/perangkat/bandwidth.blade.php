<div>
    <div class="sectioncontent-header justify-between">
        ...
        <div>
            ...
            <a href="{{ url('opd/cetak', ['section' => 'bandwidth']) }}" class="btn btn-secondary" target="_blank">
    ...
    <x-modal.modal-post id="tambah" title="{{ $id ? 'FORM EDIT DATA BANDWIDTH' : 'FORM TAMBAH DATA BANDWIDTH' }}"
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <x-input.input model="bandwidth_mbps" label="Kecepatan/Mbps"
                    placeholder="Masukan kecepatan internet yang diperlukan..." /> 
            </div>
            <div class="col-md-12">
